...
const panel = fs.readFileSync(__dirname + '/../src/panel.ts', 'utf8');
...
const spec = JSON.parse(fs.readFileSync(__dirname + '/../examples/policy-net.netgraph.json', 'utf8'));
try {
...
const spec2 = JSON.parse(fs.readFileSync(__dirname + '/../examples/wide-mlp.netgraph.json', 'utf8'));
